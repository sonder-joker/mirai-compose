...
class AutoLoginViewModel(
    ...
    private val _data: MutableStateFlow<List<LoginCredential>> = MutableStateFlow(Yaml.decodeFromString(path.readText()) ?: listOf())

    fun addAutoLoginAccount(loginCredential: LoginCredential) {
        _data.value = _data.value + loginCredential
    }
